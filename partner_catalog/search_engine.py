...
Configuration:
    SEARCH_ENGINE = "partner_catalog.search_engine.FlexibleCatalogCompatibleSearchEngine"
...
from partner_catalog.services.catalogs_aggregate import allowed_courses_qs_for_current_user
