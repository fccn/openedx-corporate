...
learner_catalogs_router = DefaultRouter()
learner_catalogs_router.register(r"catalogs", LearnerCatalogViewSet, basename="learner-catalog")

learner_catalog_nested_router = NestedDefaultRouter(learner_catalogs_router, r"catalogs", lookup="catalog")
learner_catalog_nested_router.register(r"courses", LearnerCatalogCourseViewSet, basename="learner-catalog-courses")
...
urlpatterns = [
    ...
    path("", include(learner_catalogs_router.urls)),
    path("", include(learner_catalog_nested_router.urls)),
]
