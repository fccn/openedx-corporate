    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('corporate_partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='catalogs', to='partner_catalog.corporatepartner')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('catalog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='partner_catalog.corporatepartnercatalog')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('catalog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='email_regexes', to='partner_catalog.corporatepartnercatalog')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='courses',
            field=models.ManyToManyField(related_name='partner_catalogs', through='partner_catalog.CorporatePartnerCatalogCourse', to='course_overviews.courseoverview'),
        ),
        migrations.AddField(
            model_name='corporatepartnercatalog',
            name='learners',
            field=models.ManyToManyField(related_name='enrolled_catalogs', through='partner_catalog.CorporatePartnerCatalogLearner', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddIndex(
