# corporate_partner_access/edxapp_wrapper/student_module.py
...
def add_enrollment(
    *,
    ...
    Args:
        ...
        enrollment_attributes (Optional[List[Dict[str, Any]]]): Additional attributes for the enrollment. Defaults to None.
